...
const badgeVariants = cva(
  "inline-flex items-center justify-center border border-transparent font-medium focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 [&_svg]:-ms-px [&_svg]:shrink-0",
  {
    variants: {
      ...
      size: {
        lg: "rounded-md px-2 py-1.5 min-w-7 gap-1.5 text-xs [&_svg]:size-3.5",
        md: "rounded-md px-2 py-1 min-w-6 gap-1.5 text-xs [&_svg]:size-3.5",
        sm: "rounded-sm px-1.5 py-0.5 min-w-5 gap-1 text-[0.6875rem] leading-snug [&_svg]:size-3",
        xs: "rounded-sm px-1 py-0.5 min-w-4 gap-1 text-[0.625rem] leading-snug [&_svg]:size-3",
      },
      shape: {
        default: "",
        circle: "rounded-full",
