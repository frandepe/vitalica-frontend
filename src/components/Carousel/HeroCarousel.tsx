  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-1 flex-col justify-center px-4 md:px-8">
        ...
        {/* Info & Controls */}
        <div className="mx-auto mt-12 flex w-full container mx-autoflex-col items-center justify-between gap-6 md:flex-row pointer-events-auto">
          <div className="flex flex-1 flex-col items-center text-center md:items-start md:text-left  justify-center">
