...
export default function ReasonsToTech() {
  ...
  const services = [
    {
      ...
      title: "Solo instructores certificados",
      description:
        "Vitálica es una plataforma cerrada: solo pueden publicar cursos instructores con certificaciones válidas. Esto eleva el nivel académico, protege tu reputación profesional y genera confianza real en los alumnos.",
      position: "left",
    },
    {
    ...
    },
    {
      ...
      title: "Tu contenido, tu control",
      description:
        "Vitálica no modifica, edita ni reutiliza tu material. Vos definís el enfoque, la profundidad y la forma de enseñar. La plataforma solo aporta la estructura técnica y académica.",
      position: "left",
    },
    {
      ...
      title: "Ingresos escalables en el tiempo",
      description:
        "Convertí tu experiencia presencial en un activo digital. Tu curso sigue generando ingresos sin depender de fechas, traslados ni cupos físicos.",
      position: "right",
    },
    {
      ...
      description:
        "La plataforma valida instructores y cuida el estándar académico. No sos un curso suelto en internet: formás parte de un ecosistema profesional.",
      position: "right",
    },
    {
      ...
      title: "Expandí tu alcance",
      description:
        "Llegá a alumnos que hoy no pueden asistir a tus clases presenciales. Más impacto, más alcance y más continuidad para tu trabajo como instructor.",
      position: "right",
    },
  ];
  ...
  return (
    <section
      id="about-section"
      ref={sectionRef}
      className="w-full py-24 px-4 bg-gradient-to-b text-foreground overflow-hidden relative"
    >
      ...
      />
      <motion.div
        className="absolute top-1/2 left-1/4 w-4 h-4 rounded-full bg-secondary-light/30"
        animate={{
          y: [0, -15, 0],
          opacity: [0.5, 1, 0.5],
        }}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          ...
          <div className="flex justify-center items-center order-first md:order-none mb-8 md:mb-0">
            ...
            >
              ...
              <motion.div
                className="absolute -top-10 left-1/2 -translate-x-1/2 w-3 h-3 rounded-full bg-primary/70"
                animate={{
                  y: [0, -10, 0],
                  opacity: [0.5, 1, 0.5],
                }}
