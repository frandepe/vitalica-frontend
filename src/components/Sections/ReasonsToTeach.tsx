...
function StatCounter({ icon, value, label, suffix, delay }: StatCounterProps) {
  ...
  return (
    ...
    >
      <motion.div
        className="w-14 h-14 rounded-full bg-foreground/5 flex items-center justify-center mb-4 text-[#88734C] group-hover:bg-[#88734C]/10 transition-colors duration-300"
